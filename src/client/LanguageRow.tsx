...
export type LanguageRowComponentProps =
  ...
  & PropsLocale<'dsh-plugin-better-locale'>
  & LanguageRowInjected
 ...
 */
export function LanguageRow({ t, useStore, setActive }: LanguageRowComponentProps): React.ReactNode {
    ...
    >
      ...
      >
        ...
        {showEnSwitchHint && (
          ...
          >
            {t('switchToEnHint', { label: hintLabel })}
          </div>
        )}
      </div>
      <Menu

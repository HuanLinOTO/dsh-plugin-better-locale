...
type PluginNS = {
    [L in keyof typeof ALL]: keyof (typeof ALL)[L] & string;
}[keyof typeof ALL];
/** Keys of one namespace shipped by at least one bundled language. */
type PluginKeys<N extends UpstreamNS> = {
    [L in keyof typeof ALL]: N extends keyof (typeof ALL)[L] ? keyof (typeof ALL)[L][N] & string : never;
}[keyof typeof ALL];
/** Upstream owns a namespace/key no bundled language translates (drift). */
export type Drift = Exclude<UpstreamNS, PluginNS> | {
    [K in UpstreamNS]: Exclude<UpstreamKeys<K>, PluginKeys<K>>;
}[UpstreamNS];
/** One language carries a namespace/key upstream does not own (trespass). */
export type Trespass<L extends keyof typeof ALL> = Exclude<keyof (typeof ALL)[L] & string, UpstreamNS> | {
    [K in keyof (typeof ALL)[L] & string]: K extends UpstreamNS ? Exclude<keyof (typeof ALL)[L][K] & string, UpstreamKeys<K>> : never;
}[keyof (typeof ALL)[L] & string];
/** All violations: upstream drift plus any language trespassing the table. */
type Violation = Drift | {
    [L in keyof typeof ALL]: Trespass<L>;
}[keyof typeof ALL];
/**
 ...
 */
export declare const assertUpstreamCoverage: [Violation] extends [never] ? true : {
    error: Violation;
};
export {};
